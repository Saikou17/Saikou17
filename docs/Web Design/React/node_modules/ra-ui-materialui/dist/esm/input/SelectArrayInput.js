...
export var SelectArrayInput = function (props) {
    ...
    var _k = useInput(__assign({ format: format, onBlur: onBlur, onChange: onChange, parse: parse, resource: resource, source: source, validate: validate }, rest)), field = _k.field, isRequired = _k.isRequired, _l = _k.fieldState, error = _l.error, invalid = _l.invalid, isTouched = _l.isTouched, isSubmitted = _k.formState.isSubmitted;
