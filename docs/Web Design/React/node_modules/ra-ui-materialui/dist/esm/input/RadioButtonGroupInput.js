...
export var RadioButtonGroupInput = function (props) {
    ...
    var _h = useInput(__assign({ format: format, onBlur: onBlur, onChange: onChange, parse: parse, resource: resource, source: source, validate: validate }, rest)), id = _h.id, isRequired = _h.isRequired, fieldState = _h.fieldState, field = _h.field, formState = _h.formState;
