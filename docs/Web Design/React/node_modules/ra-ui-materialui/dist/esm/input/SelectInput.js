...
export var SelectInput = function (props) {
    ...
    var _h = useInput(__assign({ defaultValue: defaultValue, parse: parse, format: format, onBlur: onBlur, onChange: onChange, resource: resource, source: source, validate: validate }, rest)), field = _h.field, fieldState = _h.fieldState, id = _h.id, isRequired = _h.isRequired, isSubmitted = _h.formState.isSubmitted;
