...
var SelectArrayInput = function (props) {
    ...
    var _k = (0, ra_core_1.useInput)(__assign({ format: format, onBlur: onBlur, onChange: onChange, parse: parse, resource: resource, source: source, validate: validate }, rest)), field = _k.field, isRequired = _k.isRequired, _l = _k.fieldState, error = _l.error, invalid = _l.invalid, isTouched = _l.isTouched, isSubmitted = _k.formState.isSubmitted;
    ...
    var _m = (0, useSupportCreateSuggestion_1.useSupportCreateSuggestion)({
        create: create,
        ...
        onCreate: onCreate,
        optionText: optionText,
    }), getCreateItem = _m.getCreateItem, handleChangeWithCreateSupport = _m.handleChange, createElement = _m.createElement;
