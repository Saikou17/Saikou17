...
var SelectInput = function (props) {
    ...
    var _h = (0, ra_core_1.useInput)(__assign({ defaultValue: defaultValue, parse: parse, format: format, onBlur: onBlur, onChange: onChange, resource: resource, source: source, validate: validate }, rest)), field = _h.field, fieldState = _h.fieldState, id = _h.id, isRequired = _h.isRequired, isSubmitted = _h.formState.isSubmitted;
    ...
    var _j = (0, useSupportCreateSuggestion_1.useSupportCreateSuggestion)({
        create: create,
    ...
    }), getCreateItem = _j.getCreateItem, handleChangeWithCreateSupport = _j.handleChange, createElement = _j.createElement;
